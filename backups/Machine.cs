...
namespace Antmicro.Renode.Core
{
    public class Machine : IMachine, IDisposable
    {
        ...
        private HashSet<IPeripheral> peripheralsToFuzz_k = new HashSet<IPeripheral>();
        ...
        public void ConfigurePeripheralsToFuzz(string[] peripheralNames)
        {
            ...
            Console.WriteLine($"^^^Machine.cs ConfigurePeripheralsToFuzz : ConfigurePeripheralsToFuzz.Count : {peripheralsToFuzz_k.Count}");
        }
